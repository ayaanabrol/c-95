                            ...
                            {this.state.allDetails.map((detail, index)=> {
                               return(
                                   <View key = {index} style = {{borderBottomWidth: 2}}>
                                       ...
                                       <Text> {"BranchName :" + detail.branchName}</Text>
                                       <Text> {"BranchNumber :" + detail.branchNumber}</Text>
                                       <Text> {"SwiftCode :" + detail.swiftCode}</Text>
                                       <Text> {"BankAccountCurrency :" + detail.banckAccountCurrency}</Text>
                                       <Text> {"IbanNo :" + detail.ibanNo}</Text>
                                       <Text> {"AccountType:" + detail.accountType}</Text>
                                   </View>
                               ) 
                            })
                            }
